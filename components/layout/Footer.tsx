    ...
    <SimpleGrid cols={2} bg="gray.2" h={configuration.footerHeight}>
      <Group>
        <Text ml={10} fz={14} fw={500}>
          ...
          <a href={"https://devcoauctioneers.co.za/"} target={"_blank"}>
            Devco Auctioneers (Pty) Ltd
          </a>
        </Text>
      </Group>
      ...
      <Flex pr={50} align={"center"} justify={"flex-end"} gap={160}>
        <Image
          onClick={() => {
            window.open(
              "https://play.google.com/store/apps/details?id=online.devco&hl=en&gl=US",
              "_blank"
            );
          }}
          mr={140}
        ...
        <Image
          onClick={() => {
            window.open(
              "https://apps.apple.com/za/app/devco-online/id6449440793",
              "_blank"
            );
          }}
          h={50}
